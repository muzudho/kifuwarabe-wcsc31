...
func PieceFromPhPt(phase Phase, pieceType PieceType) l09.Piece {
	...
	case FIRST:
		...
		case PIECE_TYPE_P:
			return l13.PIECE_P1
		case PIECE_TYPE_PR:
			return l13.PIECE_PR1
		case PIECE_TYPE_PB:
			return l13.PIECE_PB1
		case PIECE_TYPE_PS:
			return l13.PIECE_PS1
		case PIECE_TYPE_PN:
			return l13.PIECE_PN1
		case PIECE_TYPE_PL:
			return l13.PIECE_PL1
		case PIECE_TYPE_PP:
			return l13.PIECE_PP1
		default:
	...
	case SECOND:
		...
		case PIECE_TYPE_P:
			return l13.PIECE_P2
		case PIECE_TYPE_PR:
			return l13.PIECE_PR2
		case PIECE_TYPE_PB:
			return l13.PIECE_PB2
		case PIECE_TYPE_PS:
			return l13.PIECE_PS2
		case PIECE_TYPE_PN:
			return l13.PIECE_PN2
		case PIECE_TYPE_PL:
			return l13.PIECE_PL2
		case PIECE_TYPE_PP:
			return l13.PIECE_PP2
		default:
			panic(fmt.Errorf("unknown piece type=%d", pieceType))
		}
	default:
...
var HandPieceMap1 = [HAND_SIZE]l09.Piece{
	l13.PIECE_K1, l13.PIECE_R1, l13.PIECE_B1, l13.PIECE_G1, l13.PIECE_S1, l13.PIECE_N1, l13.PIECE_L1, l13.PIECE_P1,
	l13.PIECE_K2, l13.PIECE_R2, l13.PIECE_B2, l13.PIECE_G2, l13.PIECE_S2, l13.PIECE_N2, l13.PIECE_L2, l13.PIECE_P2}
	...
	BoardLoop:
		for {
			...
			case 'K', 'R', 'B', 'G', 'S', 'N', 'L', 'P', 'k', 'r', 'b', 'g', 's', 'n', 'l', 'p':
				pPos.Board[file*10+rank] = l13.FromStringToPiece(string(pc))
				file -= 1
				i += 1
			case '1', '2', '3', '4', '5', '6', '7', '8', '9':
				var spaces, _ = strconv.Atoi(string(pc))
				for sp := 0; sp < spaces; sp += 1 {
					pPos.Board[file*10+rank] = l13.PIECE_EMPTY
					file -= 1
				}
				i += 1
			case '+':
			...
			if promoted {
				...
				case 'R', 'B', 'S', 'N', 'L', 'P', 'r', 'b', 's', 'n', 'l', 'p':
					pPos.Board[file*10+rank] = l13.FromStringToPiece("+" + string(pc2))
					file -= 1
					i += 1
				default:
					panic("Undefined sfen board+")
...
func (pPosSys *PositionSystem) DoMove(pPos *Position, move Move) {
	...
	if sq_hand != 0 {
		...
		switch captured {
		case l13.PIECE_EMPTY: // Ignored
		case l13.PIECE_K1: // Second player win
			cap_dst_sq = SQ_K2
		case l13.PIECE_R1, l13.PIECE_PR1:
			cap_dst_sq = SQ_R2
		case l13.PIECE_B1, l13.PIECE_PB1:
			cap_dst_sq = SQ_B2
		case l13.PIECE_G1:
			cap_dst_sq = SQ_G2
		case l13.PIECE_S1, l13.PIECE_PS1:
			cap_dst_sq = SQ_S2
		case l13.PIECE_N1, l13.PIECE_PN1:
			cap_dst_sq = SQ_N2
		case l13.PIECE_L1, l13.PIECE_PL1:
			cap_dst_sq = SQ_L2
		case l13.PIECE_P1, l13.PIECE_PP1:
			cap_dst_sq = SQ_P2
		case l13.PIECE_K2: // First player win
			cap_dst_sq = SQ_K1
		case l13.PIECE_R2, l13.PIECE_PR2:
			cap_dst_sq = SQ_R1
		case l13.PIECE_B2, l13.PIECE_PB2:
			cap_dst_sq = SQ_B1
		case l13.PIECE_G2:
			cap_dst_sq = SQ_G1
		case l13.PIECE_S2, l13.PIECE_PS2:
			cap_dst_sq = SQ_S1
		case l13.PIECE_N2, l13.PIECE_PN2:
			cap_dst_sq = SQ_N1
		case l13.PIECE_L2, l13.PIECE_PL2:
			cap_dst_sq = SQ_L1
		case l13.PIECE_P2, l13.PIECE_PP2:
			cap_dst_sq = SQ_P1
		default:
		...
		if cap_dst_sq != SQUARE_EMPTY {
			...
			// 取った駒は無かった（＾～＾）
			pPosSys.CapturedList[pPosSys.OffsetMovesIndex] = l13.PIECE_EMPTY
		}
	}
...
func (pPosSys *PositionSystem) UndoMove(pPos *Position) {
	...
	default:
		...
		if pro {
			// 成りを元に戻します
			pPos.Board[from] = l13.Demote(pPos.Board[to])
		} else {
