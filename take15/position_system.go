...
func PieceFromPhPt(phase Phase, pieceType PieceType) l09.Piece {
	...
	case FIRST:
		...
		case PIECE_TYPE_P:
			return l14.PIECE_P1
		case PIECE_TYPE_PR:
			return l14.PIECE_PR1
		case PIECE_TYPE_PB:
			return l14.PIECE_PB1
		case PIECE_TYPE_PS:
			return l14.PIECE_PS1
		case PIECE_TYPE_PN:
			return l14.PIECE_PN1
		case PIECE_TYPE_PL:
			return l14.PIECE_PL1
		case PIECE_TYPE_PP:
			return l14.PIECE_PP1
		default:
	...
	case SECOND:
		...
		case PIECE_TYPE_P:
			return l14.PIECE_P2
		case PIECE_TYPE_PR:
			return l14.PIECE_PR2
		case PIECE_TYPE_PB:
			return l14.PIECE_PB2
		case PIECE_TYPE_PS:
			return l14.PIECE_PS2
		case PIECE_TYPE_PN:
			return l14.PIECE_PN2
		case PIECE_TYPE_PL:
			return l14.PIECE_PL2
		case PIECE_TYPE_PP:
			return l14.PIECE_PP2
		default:
			panic(App.LogNotEcho.Fatal("unknown piece type=%d", pieceType))
		}
	default:
