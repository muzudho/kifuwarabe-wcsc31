...
func GenMoveEnd(pPos *Position, from Square) []MoveEnd {
	...
	if from == SQUARE_EMPTY {
		...
		// 先手桂の利き
		if piece == l11.PIECE_N1 && 2 < Rank(from) && Rank(from) < 10 {
		...
		// 先手歩の利き
		switch piece {
		case l11.PIECE_K1, l11.PIECE_R1, l11.PIECE_PR1, l11.PIECE_PB1, l11.PIECE_G1, l11.PIECE_S1, l11.PIECE_L1, l11.PIECE_P1, l11.PIECE_PS1,
		...
		// 後手歩の利き
		switch piece {
		case l11.PIECE_K2, l11.PIECE_R2, l11.PIECE_PR2, l11.PIECE_PB2, l11.PIECE_G2, l11.PIECE_S2, l11.PIECE_L2, l11.PIECE_P2, l11.PIECE_PS2,
